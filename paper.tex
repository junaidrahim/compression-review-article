...
In order to understand different algorithms we need to know about some basic terms like prefix codes and entropy. A prefix code is a 'code' system in which the codes given to each character is not the prefix of the code given to any other character i.e. it follows the prefix property \cite{berstel1985theory}. For example $\{2,42,12\}$ is an example of a prefix system whereas $\{2,42,12,21\}$ is not because '2' is the prefix of '21'.
